...
PERM double *u_i0; // = (double*)malloc(sizeof(double) * narea);
PERM double *u_i1; //= (double*)malloc(sizeof(double) * narea);
PERM double *pebs; //= (double*)malloc(sizeof(double) * narea);
PERM double t;
