...
typedef struct {
	...
	void *swap_end;
	void *swap_max;
	extent_tree_t swap_chunks_szad;
	extent_tree_t swap_chunks_ad;
...
extern malloc_mutex_t	init_lock;
 ...
 */
/* Internal heap base address */
#define base_pages (plib->base_pages)
/* Internal heap end address */
#define base_next_addr (plib->base_next_addr)
/* Internal heap max address */
#define base_past_addr (plib->base_past_addr)
/* Internal heap free node list */
#define base_nodes (plib->base_nodes)

/* src/chunk_swap.c */
/* Base address of the mmap()ed file(s). */
#define swap_base (plib->swap_base)
/* Current end of the space in use (<= swap_max). */
#define swap_end (plib->swap_end)
/* Absolute upper limit on file-backed addresses. */
#define swap_max (plib->swap_max)
/*
 ...
 */
#define swap_chunks_szad (plib->swap_chunks_szad)
#define swap_chunks_ad (plib->swap_chunks_ad)

/* src/huge.c */
/* Tree of chunks that are stand-alone huge allocations. */
#define huge (plib->huge)
 ...
 */
#define parenas (plib->parenas)
#define narenas (plib->narenas)
